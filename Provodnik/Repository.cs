...
public    class Repository
    {
        ...
        public string GetF6Depo(string city, string depo)
        {
            ...
            if (city == "Санкт-Петербург") return "Вагонного участка Санкт-Петербург-Московский Северо-Западного филиала АО «ФПК»";
            if (city == "Новороссийск") return "Пассажирского вагонного депо Новороссийск Северо-Кавказского филиала АО «ФПК»";

            if (depo == "М – Николаевка") return "Пассажирского вагонного депо Николаевка Московского филиала АО «ФПК»";
            if (depo == "М – Киевская") return "Пассажирского вагонного депо Москва-Киевская Московского филиала АО «ФПК»";
            if (depo == "М – Ярославская") return "Пассажирского вагонного депо Москва-Ярославская Московского филиала АО «ФПК»";
